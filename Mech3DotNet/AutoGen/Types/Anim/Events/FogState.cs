...
namespace Mech3DotNet.Types.Anim.Events
{
    public sealed class FogState
    {
        ...
        public Mech3DotNet.Types.Range altitude;
        public Mech3DotNet.Types.Range range;

        public FogState(string name, Mech3DotNet.Types.Anim.Events.FogType fogType, Mech3DotNet.Types.Color color, Mech3DotNet.Types.Range altitude, Mech3DotNet.Types.Range range)
        {
            this.name = name;
        ...
        private struct Fields
        {
            ...
            public Field<Mech3DotNet.Types.Range> altitude;
        ...
        public static void Serialize(FogState v, Serializer s)
        {
            ...
            s.Serialize(Mech3DotNet.Types.RangeConverter.Converter)(v.altitude);
        ...
        public static FogState Deserialize(Deserializer d)
        {
            var fields = new Fields()
            {
                ...
                altitude = new Field<Mech3DotNet.Types.Range>(),
            ...
            foreach (var fieldName in d.DeserializeStruct())
            {
                switch (fieldName)
                {
                    ...
                    case "color":
                        ...
                        break;
                    case "altitude":
                        fields.altitude.Value = d.Deserialize(Mech3DotNet.Types.RangeConverter.Converter)();
                        break;
                    case "range":
