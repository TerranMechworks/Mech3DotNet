...
namespace Mech3DotNet.Types.Anim.Events
{
    public sealed class Vec3FromTo
    {
        ...
        public Mech3DotNet.Types.Vec3 from;
        public Mech3DotNet.Types.Vec3 to;
        public Mech3DotNet.Types.Vec3 delta;

        public Vec3FromTo(Mech3DotNet.Types.Vec3 from, Mech3DotNet.Types.Vec3 to, Mech3DotNet.Types.Vec3 delta)
        {
            this.from = from;
            this.to = to;
            this.delta = delta;
        ...
        {
            public Field<Mech3DotNet.Types.Vec3> from;
            public Field<Mech3DotNet.Types.Vec3> to;
        ...
        public static void Serialize(Vec3FromTo v, Serializer s)
        {
            ...
            s.Serialize(Mech3DotNet.Types.Vec3Converter.Converter)(v.from);
            s.SerializeFieldName("to");
            s.Serialize(Mech3DotNet.Types.Vec3Converter.Converter)(v.to);
        ...
        public static Vec3FromTo Deserialize(Deserializer d)
        {
            ...
            {
                from = new Field<Mech3DotNet.Types.Vec3>(),
                to = new Field<Mech3DotNet.Types.Vec3>(),
            ...
            foreach (var fieldName in d.DeserializeStruct())
            {
                ...
                {
                    case "from":
                        fields.from.Value = d.Deserialize(Mech3DotNet.Types.Vec3Converter.Converter)();
                        break;
                    case "to":
                        fields.to.Value = d.Deserialize(Mech3DotNet.Types.Vec3Converter.Converter)();
                        break;
                    case "delta":
