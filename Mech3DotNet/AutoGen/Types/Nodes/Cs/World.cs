...
namespace Mech3DotNet.Types.Nodes.Cs
{
    public sealed class World
    {
        ...
        public System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionNg>> partitions;
        public bool flags;
        public uint areaPartitionCount;
        public uint areaPartitionPtr;
        public uint virtPartitionXMin;
        public uint virtPartitionYMin;
        ...
        public World(string name, Mech3DotNet.Types.Nodes.Area area, System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionNg>> partitions, bool flags, uint areaPartitionCount, uint areaPartitionPtr, uint virtPartitionXMin, uint virtPartitionYMin, uint virtPartitionPtr, uint worldChildrenPtr, uint worldChildValue, uint worldLightsPtr, System.Collections.Generic.List<uint> children, uint dataPtr, uint childrenArrayPtr)
        {
            this.name = name;
            this.area = area;
            this.partitions = partitions;
            this.flags = flags;
            this.areaPartitionCount = areaPartitionCount;
            this.areaPartitionPtr = areaPartitionPtr;
            this.virtPartitionXMin = virtPartitionXMin;
            this.virtPartitionYMin = virtPartitionYMin;
        ...
        private struct Fields
        {
            ...
            public Field<System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionNg>>> partitions;
            public Field<bool> flags;
            public Field<uint> areaPartitionCount;
            public Field<uint> areaPartitionPtr;
            public Field<uint> virtPartitionXMin;
            public Field<uint> virtPartitionYMin;
        ...
        public static void Serialize(World v, Serializer s)
        {
            ...
            s.SerializeVec(s.SerializeVec(s.Serialize(Mech3DotNet.Types.Nodes.PartitionNg.Converter)))(v.partitions);
            s.SerializeFieldName("flags");
            ((Action<bool>)s.SerializeBool)(v.flags);
            s.SerializeFieldName("area_partition_count");
            ((Action<uint>)s.SerializeU32)(v.areaPartitionCount);
            s.SerializeFieldName("area_partition_ptr");
            ((Action<uint>)s.SerializeU32)(v.areaPartitionPtr);
            s.SerializeFieldName("virt_partition_x_min");
            ((Action<uint>)s.SerializeU32)(v.virtPartitionXMin);
            s.SerializeFieldName("virt_partition_y_min");
            ((Action<uint>)s.SerializeU32)(v.virtPartitionYMin);
        ...
        public static World Deserialize(Deserializer d)
        {
            var fields = new Fields()
            {
                ...
                partitions = new Field<System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionNg>>>(),
                flags = new Field<bool>(),
                areaPartitionCount = new Field<uint>(),
                areaPartitionPtr = new Field<uint>(),
                virtPartitionXMin = new Field<uint>(),
                virtPartitionYMin = new Field<uint>(),
            ...
            foreach (var fieldName in d.DeserializeStruct())
            {
                switch (fieldName)
                {
                    ...
                    case "area":
                        ...
                        break;
                    case "partitions":
                        fields.partitions.Value = d.DeserializeVec(d.DeserializeVec(d.Deserialize(Mech3DotNet.Types.Nodes.PartitionNg.Converter)))();
                        break;
                    case "flags":
                        fields.flags.Value = d.DeserializeBool();
                        break;
                    case "area_partition_count":
                        fields.areaPartitionCount.Value = d.DeserializeU32();
                        break;
                    case "area_partition_ptr":
                        fields.areaPartitionPtr.Value = d.DeserializeU32();
                        break;
                    case "virt_partition_x_min":
                        fields.virtPartitionXMin.Value = d.DeserializeU32();
                        break;
                    case "virt_partition_y_min":
                        fields.virtPartitionYMin.Value = d.DeserializeU32();
                        break;
            ...
            return new World(
                ...
                fields.flags.Unwrap("World", "flags"),

                fields.areaPartitionCount.Unwrap("World", "areaPartitionCount"),

                fields.areaPartitionPtr.Unwrap("World", "areaPartitionPtr"),

                fields.virtPartitionXMin.Unwrap("World", "virtPartitionXMin"),

                fields.virtPartitionYMin.Unwrap("World", "virtPartitionYMin"),
