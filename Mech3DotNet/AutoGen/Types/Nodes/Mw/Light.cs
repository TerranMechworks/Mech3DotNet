...
namespace Mech3DotNet.Types.Nodes.Mw
{
    public sealed class Light
    {
        ...
        public string name;
        public Mech3DotNet.Types.Vec3 direction;
        ...
        public Light(string name, Mech3DotNet.Types.Vec3 direction, float diffuse, float ambient, Mech3DotNet.Types.Color color, Mech3DotNet.Types.Range range, uint parentPtr, uint dataPtr)
        {
            this.name = name;
        ...
        private struct Fields
        {
            ...
            public Field<Mech3DotNet.Types.Vec3> direction;
        ...
        public static void Serialize(Light v, Serializer s)
        {
            ...
            s.Serialize(Mech3DotNet.Types.Vec3Converter.Converter)(v.direction);
        ...
        public static Light Deserialize(Deserializer d)
        {
            var fields = new Fields()
            {
                ...
                direction = new Field<Mech3DotNet.Types.Vec3>(),
            ...
            foreach (var fieldName in d.DeserializeStruct())
            {
                switch (fieldName)
                {
                    case "name":
                        ...
                        break;
                    case "direction":
                        fields.direction.Value = d.Deserialize(Mech3DotNet.Types.Vec3Converter.Converter)();
                        break;
                    case "diffuse":
