...
namespace Mech3DotNet.Types.Nodes.Pm
{
    public sealed class World
    {
        ...
        public World(string name, Mech3DotNet.Types.Nodes.Area area, System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionNg>> partitions, bool virtualPartition, uint areaPartitionCount, uint areaPartitionPtr, uint virtPartitionPtr, uint worldChildrenPtr, uint worldChildValue, uint worldLightsPtr, System.Collections.Generic.List<uint> children, uint dataPtr, uint childrenArrayPtr)
        {
            this.name = name;
            this.area = area;
