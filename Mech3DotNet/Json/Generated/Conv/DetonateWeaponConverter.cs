...
{
    public class DetonateWeaponConverter : Mech3DotNet.Json.Converters.StructConverter<Mech3DotNet.Json.Anim.Events.DetonateWeapon>
    {
        protected override Mech3DotNet.Json.Anim.Events.DetonateWeapon ReadStruct(ref Utf8JsonReader __reader, JsonSerializerOptions __options)
        {
            ...
            return new Mech3DotNet.Json.Anim.Events.DetonateWeapon(name, atNode);
        }

        public override void Write(Utf8JsonWriter writer, Mech3DotNet.Json.Anim.Events.DetonateWeapon value, JsonSerializerOptions options)
        {
