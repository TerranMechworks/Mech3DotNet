...
{
    public class LodPmConverter : Mech3DotNet.Json.Converters.StructConverter<Mech3DotNet.Json.Nodes.Pm.LodPm>
    {
        protected override Mech3DotNet.Json.Nodes.Pm.LodPm ReadStruct(ref Utf8JsonReader __reader, JsonSerializerOptions __options)
        {
            ...
            return new Mech3DotNet.Json.Nodes.Pm.LodPm(name, level, range, unk64, unk72, parent, children, dataPtr, parentArrayPtr, childrenArrayPtr, unk164);
        }

        public override void Write(Utf8JsonWriter writer, Mech3DotNet.Json.Nodes.Pm.LodPm value, JsonSerializerOptions options)
        {
