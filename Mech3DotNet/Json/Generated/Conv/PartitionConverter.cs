...
{
    public class PartitionConverter : Mech3DotNet.Json.Converters.StructConverter<Mech3DotNet.Json.Nodes.Partition>
    {
        protected override Mech3DotNet.Json.Nodes.Partition ReadStruct(ref Utf8JsonReader __reader, JsonSerializerOptions __options)
        {
            var xField = new Mech3DotNet.Json.Converters.Option<int>();
            var yField = new Mech3DotNet.Json.Converters.Option<int>();
            var zMinField = new Mech3DotNet.Json.Converters.Option<float>();
            var zMaxField = new Mech3DotNet.Json.Converters.Option<float>();
            var zMidField = new Mech3DotNet.Json.Converters.Option<float>();
            var nodesField = new Mech3DotNet.Json.Converters.Option<System.Collections.Generic.List<uint>>();
            ...
            return new Mech3DotNet.Json.Nodes.Partition(x, y, zMin, zMax, zMid, nodes, ptr);
        }

        public override void Write(Utf8JsonWriter writer, Mech3DotNet.Json.Nodes.Partition value, JsonSerializerOptions options)
        {
