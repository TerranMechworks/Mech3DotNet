...
{
    public class TranslateDataConverter : Mech3DotNet.Json.Converters.StructConverter<Mech3DotNet.Json.Anim.Events.TranslateData>
    {
        protected override Mech3DotNet.Json.Anim.Events.TranslateData ReadStruct(ref Utf8JsonReader __reader, JsonSerializerOptions __options)
        {
            ...
            return new Mech3DotNet.Json.Anim.Events.TranslateData(value, unk);
        }

        public override void Write(Utf8JsonWriter writer, Mech3DotNet.Json.Anim.Events.TranslateData value, JsonSerializerOptions options)
        {
