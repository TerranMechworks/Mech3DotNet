...
{
    public class WindowConverter : Mech3DotNet.Json.Converters.StructConverter<Mech3DotNet.Json.Nodes.Mw.Window>
    {
        protected override Mech3DotNet.Json.Nodes.Mw.Window ReadStruct(ref Utf8JsonReader __reader, JsonSerializerOptions __options)
        {
            ...
            return new Mech3DotNet.Json.Nodes.Mw.Window(name, resolutionX, resolutionY, dataPtr);
        }

        public override void Write(Utf8JsonWriter writer, Mech3DotNet.Json.Nodes.Mw.Window value, JsonSerializerOptions options)
        {
