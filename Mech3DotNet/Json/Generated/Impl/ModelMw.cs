namespace Mech3DotNet.Json.Gamez.Mechlib
{
    ...
    public class ModelMw
    {
        ...
        public ModelMw(System.Collections.Generic.List<Mech3DotNet.Json.Nodes.Mw.NodeMw> nodes, System.Collections.Generic.List<Mech3DotNet.Json.Gamez.Mesh.Mw.MeshMw> meshes, System.Collections.Generic.List<int> meshPtrs)
        {
            this.nodes = nodes;
            this.meshes = meshes;
