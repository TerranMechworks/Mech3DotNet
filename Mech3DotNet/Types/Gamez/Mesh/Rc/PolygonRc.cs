...
namespace Mech3DotNet.Types.Gamez.Mesh.Rc
{
    public sealed class PolygonRc
    {
        ...
        public PolygonRc(System.Collections.Generic.List<uint> vertexIndices, System.Collections.Generic.List<uint>? normalIndices, System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.UvCoord>? uvCoords, uint materialIndex, bool unk0Flag, int unk04, uint unk24, uint verticesPtr, uint normalsPtr, uint uvsPtr)
        {
        ...
        public static PolygonRc Deserialize(Deserializer d)
        {
            ...
            return new PolygonRc(
                ...
                fields.materialIndex.Unwrap("PolygonRc", "materialIndex"),
