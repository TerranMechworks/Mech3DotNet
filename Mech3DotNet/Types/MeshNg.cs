...
namespace Mech3DotNet.Types.Gamez.Mesh.Ng
{
    public sealed class MeshNg
    {
        ...
        public System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.MeshTexture> textures;
        ...
        private struct Fields
        {
            ...
            public Field<System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.MeshTexture>> textures;
        ...
        public static void Serialize(MeshNg v, Serializer s)
        {
            ...
            s.SerializeVec(s.Serialize(Mech3DotNet.Types.Gamez.Mesh.Ng.MeshTexture.Converter))(v.textures);
            ...
            s.SerializeFieldName("texture_ptr");
            ((Action<uint>)s.SerializeU32)(v.texturePtr);
        ...
        public static MeshNg Deserialize(Deserializer d)
        {
            var fields = new Fields()
            {
                ...
                textures = new Field<System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.MeshTexture>>(),
            ...
            foreach (var fieldName in d.DeserializeStruct("MeshNg"))
            {
                switch (fieldName)
                {
                    ...
                    case "polygons":
                        ...
                        break;
                    case "textures":
                        fields.textures.Value = d.DeserializeVec(d.Deserialize(Mech3DotNet.Types.Gamez.Mesh.Ng.MeshTexture.Converter))();
                        break;
                    case "polygons_ptr":
                    ...
                    case "morphs_ptr":
                        ...
                        break;
                    case "texture_ptr":
                        fields.texturePtr.Value = d.DeserializeU32();
                        break;
                    case "file_ptr":
            ...
            return new MeshNg(
                ...
                fields.textures.Unwrap("MeshNg", "textures"),
                ...
                fields.texturePtr.Unwrap("MeshNg", "texturePtr"),
