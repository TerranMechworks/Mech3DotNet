...
namespace Mech3DotNet.Types.Nodes.Mw
{
    public sealed class World
    {
        ...
        public World(string name, Mech3DotNet.Types.Nodes.Area area, System.Collections.Generic.List<System.Collections.Generic.List<Mech3DotNet.Types.Nodes.PartitionPg>> partitions, uint areaPartitionXCount, uint areaPartitionYCount, bool fudgeCount, uint areaPartitionPtr, uint virtPartitionPtr, uint worldChildrenPtr, uint worldChildValue, uint worldLightsPtr, System.Collections.Generic.List<uint> children, uint dataPtr, uint childrenArrayPtr)
        {
            this.name = name;
            this.area = area;
