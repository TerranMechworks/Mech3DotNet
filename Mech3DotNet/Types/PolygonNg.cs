...
namespace Mech3DotNet.Types.Gamez.Mesh.Ng
{
    public sealed class PolygonNg
    {
        ...
        public System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.PolygonTextureNg> textures;
        public int unk04;
        ...
        private struct Fields
        {
            ...
            public Field<System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.PolygonTextureNg>> textures;
        ...
        public static void Serialize(PolygonNg v, Serializer s)
        {
            ...
            s.SerializeVec(s.Serialize(Mech3DotNet.Types.Gamez.Mesh.Ng.PolygonTextureNg.Converter))(v.textures);
        ...
        public static PolygonNg Deserialize(Deserializer d)
        {
            var fields = new Fields()
            {
                ...
                textures = new Field<System.Collections.Generic.List<Mech3DotNet.Types.Gamez.Mesh.Ng.PolygonTextureNg>>(),
                unk04 = new Field<int>(),
            ...
            foreach (var fieldName in d.DeserializeStruct())
            {
                switch (fieldName)
                {
                    ...
                    case "normal_indices":
                        ...
                        break;
                    case "textures":
                        fields.textures.Value = d.DeserializeVec(d.Deserialize(Mech3DotNet.Types.Gamez.Mesh.Ng.PolygonTextureNg.Converter))();
                        break;
                    case "unk04":
            ...
            return new PolygonNg(
                ...
                fields.textures.Unwrap("PolygonNg", "textures"),
