...
namespace Mech3DotNet.Types.Anim.Events
{
    public sealed class Sound
    {
        ...
        public static void Serialize(Mech3DotNet.Types.Anim.Events.Sound v, Serializer s)
        {
            s.SerializeStruct("Sound", 2);
        ...
        public static Mech3DotNet.Types.Anim.Events.Sound Deserialize(Deserializer d)
        {
            ...
            foreach (var fieldName in d.DeserializeStruct("Sound"))
            {
                switch (fieldName)
                {
                    case "name":
